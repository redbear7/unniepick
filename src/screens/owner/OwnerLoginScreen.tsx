...
const styles = StyleSheet.create({
  ...
  emoji:     { fontSize: 56 },
  title:     { fontSize: 26, fontFamily: 'WantedSans-ExtraBold', fontWeight: '800', color: COLORS.text },
  subtitle:  { fontSize: 14, color: COLORS.textMuted },
  card: {
    backgroundColor: COLORS.white, borderRadius: RADIUS.lg, padding: 24, gap: 12,
  },
  label: { fontSize: 14, fontFamily: 'WantedSans-Bold', fontWeight: '700', color: COLORS.text },
  input: {
  ...
  checkMark:   { fontSize: 12, color: COLORS.white, fontFamily: 'WantedSans-Black', fontWeight: '900' },
  ...
  clearText:   { fontSize: 11, color: '#DC2626', fontFamily: 'WantedSans-Bold', fontWeight: '700' },
