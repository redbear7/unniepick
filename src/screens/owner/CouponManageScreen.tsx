...
const styles = StyleSheet.create({
  ...
  addText: { fontSize: 16, color: COLORS.primary, fontFamily: 'WantedSans-Bold', fontWeight: '700' },
  ...
  badgeText: { fontSize: 11, fontFamily: 'WantedSans-Bold', fontWeight: '700', color: COLORS.text },
  couponTitle: { flex: 1, fontSize: 15, fontFamily: 'WantedSans-Bold', fontWeight: '700', color: COLORS.text },
  infoRow: { flexDirection: 'row', justifyContent: 'space-between' },
  infoLabel: { fontSize: 13, color: COLORS.textMuted },
  infoValue: { fontSize: 13, fontFamily: 'WantedSans-SemiBold', fontWeight: '600', color: COLORS.text },
  progressBg: {
  ...
  btnText: { fontSize: 13, fontFamily: 'WantedSans-Bold', fontWeight: '700', color: COLORS.text },
});
