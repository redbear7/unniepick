...
const styles = StyleSheet.create({
  ...
  backText: { fontSize: 16, color: COLORS.white, fontFamily: 'WantedSans-SemiBold', fontWeight: '600' },
  title: { fontSize: 18, fontFamily: 'WantedSans-ExtraBold', fontWeight: '800', color: COLORS.white },
  ...
  modeBtnText: { fontSize: 14, fontFamily: 'WantedSans-SemiBold', fontWeight: '600', color: '#999' },
  ...
  scanHint: { color: COLORS.white, fontSize: 14, fontFamily: 'WantedSans-Medium', fontWeight: '500', textAlign: 'center' },
  processingOverlay: {
    position: 'absolute', top: 0, left: 0, right: 0, bottom: 0,
  ...
  rescanText: { color: COLORS.white, fontSize: 15, fontFamily: 'WantedSans-Bold', fontWeight: '700' },
  ...
  permissionBtnText: { color: COLORS.white, fontFamily: 'WantedSans-Bold', fontWeight: '700' },
});
